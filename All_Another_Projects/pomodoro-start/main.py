...
label_1 = Label(text="Timer", foreground=GREEN, font=(GREEN, 20, "bold"), highlightthickness=0, background=YELLOW)
...
label_2 = Label(foreground=GREEN, font=(GREEN, 15, "bold"), highlightthickness=0, background=YELLOW)
